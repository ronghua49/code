            ...
            <div class="box">
                <div class="box-body">
                    <ul class="nav nav-tabs">
                        <li id="undone" class="${param.type == '1' ? 'active' : ''}"><a href="/inventory/parts/stream？type=1">入库流水</a></li>
                        <li id="done" class="${param.type == '2' ? 'active' : ''}"><a href="/inventory/parts/stream？type=2">出库流水</a></li>
                    </ul>
                    <table class="table">
                        <thead>
