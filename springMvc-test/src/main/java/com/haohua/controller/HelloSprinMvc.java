...
public class HelloSprinMvc {
     ...
     * @param model 传值对象 可以向控制器和页面传递值
     * @return 发送地址到视图解析器解析
     */
        @PostMapping("/login")
        public String afterLogin(String username, String address,Model model){
    ...
    @GetMapping("/home")
    public String home( String username,String address,Model model){
            model.addAttribute("username",username);
            model.addAttribute("address",address);
            return "user/home";
    }
